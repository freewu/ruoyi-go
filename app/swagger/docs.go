    ...
    "paths": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/domain.DepartmentAddRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/system/department/list": {
            "get": {
                ...
                "responses": {
                    "0": {
                        "description": "{\"code\": 0, \"msg\": \"Success\",\"data\": { \"list\": [],\"total\": 0 } }",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/response.Response"
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/domain.DepartmentEditRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        "domain.Department": {
            ...
            "properties": {
                ...
                "createBy": {
                    "description": "DeleteFlag\tuint\t` + "`" + `json:\"deleteFlag\" form:\"deleteFlag\" gorm:\"type:tinyint(3);default:0;comment:删除标志（0代表存在 2代表删除）\"` + "`" + ` // 删除标志（0代表存在 2代表删除）",
                    "type": "string"
                },
                "createdAt": {
                    "type": "string"
        ...
        "domain.User": {
            ...
            "properties": {
                ...
                "birthday": {
                    "description": "Birthday     \tcore.LocalDate \t` + "`" + `json:\"birthday\" form:\"birthday\" time_format:\"2006-01-02\" time_utc:\"1\" gorm:\"default:null;comment:生日\"` + "`" + ` // 生日",
                    "type": "string"
                },
                "createdAt": {
                    "type": "string"
